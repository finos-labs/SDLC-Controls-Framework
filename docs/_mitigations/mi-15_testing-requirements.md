...
ase. [SDLC-PREV-014]({% link _mitigations/mi-14_test-evidence.md %}) (Test Evidence Retention) ensures the records of completed testing are preserved. All three are required for a complete testing assurance posture
